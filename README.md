...
> Gồm: postgres, api, web. Xem `infra/docker-compose.yml`.
> Frontend dùng `apps/web/Dockerfile`, backend dùng `apps/api/Dockerfile`.

## AI Tool Evidence

Dự án có minh chứng sử dụng AI tool trong quá trình phát triển. Xem file `AI_TOOL_PROMPTS.md` để biết danh sách prompts và mục đích sử dụng.
